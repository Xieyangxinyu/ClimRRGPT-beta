...
def FWI_retrieval(lat, lon):
    ...
    return output, [f"Fire Weather Index (FWI) Data for Location (lat: {lat}, lon: {lon}) within a 36 km radius, shown at a grid cell level.", FWIMapDisplay(maps_dict)], [fig2, fig]
